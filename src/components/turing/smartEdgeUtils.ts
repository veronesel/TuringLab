...
// Returns the intersection point of the line between the center of intersectionNode and targetNode
export function getNodeIntersection(intersectionNode: InternalNode, targetNode: InternalNode) {
...
// Returns the position (Top, Right, Bottom, Left) of the intersection point on the node
...
// Returns the parameters (sx, sy, tx, ty, sourcePos, targetPos) for a bezier edge
